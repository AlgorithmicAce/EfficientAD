...
def main():
    ...
    # student.load_state_dict(torch.load('student_final.pth', map_location = 'cpu'))
    # autoencoder = get_autoencoder(out_channels)
    # autoencoder.load_state_dict(torch.load('autoenoder_final.pth', map_location = 'cpu'))
    teacher = torch.load('teacher_final.pth')
    student = torch.load('student_final.pth')
    autoencoder = torch.load('autoencoder_final.pth')
